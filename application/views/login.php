...
<head>
    ...
    <title>Sen Karya Cemerlang | Login</title>
    ...
    <style>
        ...
        body {
            background-image: url('<?= base_url('assets/img/laut.png') ?>');
            ...
            /* Membuat gambar tetap saat scrolling */
        }

        .image-container img {
            width: 150px;
            /* Mengatur lebar gambar logo */
            height: auto;
        ...
        .card {
            ...
            /* Membuat background kartu semi-transparan */
            border-radius: 10px;
                        ...
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <div class="image-container">
                                    <img src="<?= base_url('assets\img\Logoskc.jpeg') ?>" alt="Logo SKC" class="img-fluid mx-auto d-block">
                                </div>
                                <div class="mt-3">
