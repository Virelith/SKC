...
<head>
    ...
    <title>Absensi PT Sen Karya Cemerlang</title>
                ...
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <div class="image-container">
                            <img src="<?= base_url('assets\img\Logoskc.jpeg') ?>" alt="Logo SKC" class="img-fluid mx-auto d-block" style="width: 150px; height: auto;">
                        </div>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2025 <a href="http://SenKaryaCemerlang.co.id">SenKaryaCemerlang</a>
                        </p>
                    </nav>
                </div>
            </footer>
